        ...
        <div className='w-[60%] h-[50%]  flex items-center justify-center'>
         ...
         <div className="text-3xl sm:text-5xl flex flex-col gap-20">  
            ...
            <div className='mr-4 flex justify-around'>
                <Link to="/" className="px-[3vw] py-[1.5vw] rounded-md bg-sky-200 mr-4 text-3xl text-red-300">Home</Link>
                <Link to="/high" className="px-[3vw] py-[1.5vw] rounded-md  bg-sky-200  text-3xl text-red-300">High score</Link>
            </div>
            </div> 
        </div>
    )
